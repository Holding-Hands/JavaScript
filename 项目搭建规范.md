...
VSCode需要安装一个插件：EditorConfig for VS Code
 ...
 ![](https://s3.bmp.ovh/imgs/2024/02/28/fc5e701580b30fd2.png) 
...
​	 ![](https://s3.bmp.ovh/imgs/2024/02/27/f9ba576ce81019fd.png) 
...
2.VSCode需要安装ESLint插件：
 ...
 ![](https://s3.bmp.ovh/imgs/2024/02/27/16e3f688a569d781.png) 
...
// 如果在window中不识别 是因为使用powershell，可以尝试下面方式，或者手动按照下面三步来安装
npx husky-init '&&' npm install
```
...
![](https://s3.bmp.ovh/imgs/2024/02/27/dd18725e006f57e1.png)
...
```
 ...
 ![](https://s3.bmp.ovh/imgs/2024/02/27/2c8218ff3887c204.png) 

3.在package.json中添加一个脚本：

 ![](https://s3.bmp.ovh/imgs/2024/02/27/5b7d3941f4aebe69.png) 

接下来，我们需要去完成一个操作：在进行commit时，执行lint脚本：

 ![](https://s3.bmp.ovh/imgs/2024/02/28/bcc517e6d5e633c5.png) 
...
![](https://s3.bmp.ovh/imgs/2024/02/28/95069eb5e25af997.png) 
...
这个命令会帮助我们安装cz-conventional-changelog：
 ...
 ![](https://s3.bmp.ovh/imgs/2024/02/28/d2695b67c4495903.png) 

并且在package.json中进行配置：

 ![](https://s3.bmp.ovh/imgs/2024/02/28/a6d11d14b3061267.png) 
...
! ![](https://s3.bmp.ovh/imgs/2024/02/28/0e0cf4211e1b1dab.png) 

* 第三步选择提交的信息

 ![](https://s3.bmp.ovh/imgs/2024/02/28/048e67c962271cbc.png) 

* 第四步提交详细的描述信息

 ![](https://s3.bmp.ovh/imgs/2024/02/28/8b12852f415c8224.png) 

* 第五步是否是一次重大的更改

 ![](https://s3.bmp.ovh/imgs/2024/02/28/5678037988815c81.png) 

* 第六步是否影响某个open issue

 ![](https://s3.bmp.ovh/imgs/2024/02/28/e499a2c39bacfda1.png) 

我们也可以在scripts中构建一个命令来执行 cz：

 ![](https://s3.bmp.ovh/imgs/2024/02/28/9bb9956538ea36af.png) 
